...
class Funcao3Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_funcao3)
        ...
        navigationView.setCheckedItem(R.id.nav_funcao3)
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        //Nomeia a tela.
        supportActionBar?.title = "Função 3"
