...
class Funcao2Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_funcao2)
        ...
        navigationView.setCheckedItem(R.id.nav_funcao2)
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        //Nomeia a tela.
        supportActionBar?.title = "Função 2"
